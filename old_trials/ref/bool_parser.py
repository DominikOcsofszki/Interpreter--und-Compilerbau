...
# gen = None
genHelper = gen_helper.GeneratorHelper(bool_ast_class.used_procedures_and_classes,gen_bool)
...
gen_bool = genHelper.set_generator_module_and_check(bool_ast_class)
